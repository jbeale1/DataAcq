...
# b3,b2: Sample Rate 00=240 SPS (12 bits), 01 = 60 SPS (14 bits)
#  10 = 15 SPS (16 bits),  11 = 3.75 SPS (18 bits)
# b1,b00  G1-G0: PGA Gain 00 = x1  01 = x2  10 = x4   11 = x8
...
# start ADC conversion, but current value is junk because previous settings unknown
...
# oldsec = t.second + t.microsecond/1000000.0
