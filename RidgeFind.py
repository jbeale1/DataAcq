...
# ---------------------------------------------------
imgThresh = 46  # critical value to extract clean curves, may drift with time/temp/etc
...
# print(src_path , fname_out)  # DEBUG
